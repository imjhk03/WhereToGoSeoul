 ...
 */
public class DetailThreeActivity_JPN extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (zipcode == null) {
            ...
            three_detail_zipcode.setText("- 郵便番号 : " + zipcode);
        }
        if (addr2 == null) {
            three_detail_addr1.setText("- アドレス : " + addr1);
        } else {
            three_detail_addr1.setText("- アドレス : " + addr1 + " " + addr2);
        }
        if (tel == null) {
            three_detail_tel.setText("- 電話番号 : N/A");
            ...
            tel = tel.replaceAll("<br/>", "\n");
            tel = tel.replaceAll("&nbsp;", " ");
            three_detail_tel.setText("- 電話番号 : " + tel);
        }
        ...
        String strUrl1 = "http://api.visitkorea.or.kr/openapi/service/rest/JpnService/detailCommon?areaCode=1&MobileOS=ETC&MobileApp=app&ServiceKey=834oAdPjoTtX%2FCihn6VDwM6KuVD3qhnZxf%2F%2F9vJ3emazbqrFpz1CV%2BULbzJUOhr7c797esiz8MaaeHQoq%2BSCbA%3D%3D&defaultYN=Y&overviewYN=Y&contentId=" + contentid;
        downTask1.execute(strUrl1);

        DownloadWebpageTask downTask = new DownloadWebpageTask();
        System.out.println(contentid);
        String strUrl = "http://api.visitkorea.or.kr/openapi/service/rest/JpnService/detailIntro?areaCode=1&MobileOS=ETC&MobileApp=app&ServiceKey=834oAdPjoTtX%2FCihn6VDwM6KuVD3qhnZxf%2F%2F9vJ3emazbqrFpz1CV%2BULbzJUOhr7c797esiz8MaaeHQoq%2BSCbA%3D%3D&contentId=" + contentid + "&contentTypeId=80&MobileOS=AND&MobileApp=AppTesting";
        downTask.execute(strUrl);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {//버튼을 누르면 실행됨
                Intent intent1 = new Intent(DetailThreeActivity_JPN.this, ShowMapOne.class);//인텐트로 보내지는곳의 클래스와,보낼곳의 위치 DetailOneActivity->ShowMapOne
