 ...
 */
public class DetailThreeActivity_CHN extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DetailCommon.setText("常见的详细信息");
        OverView.setText("概观");
        OperationGuide.setText("操作指南");
        ...
        if (zipcode == null) {
            ...
            three_detail_zipcode.setText("- 邮政编码 : " + zipcode);
        }
        if (addr2 == null) {
            three_detail_addr1.setText("- 地址 : " + addr1);
        } else {
            three_detail_addr1.setText("- 地址 : " + addr1 + " " + addr2);
        }
        if (tel == null) {
            three_detail_tel.setText("- 电话 : N/A");
            ...
            tel = tel.replaceAll("<br/>", "\n");
            tel = tel.replaceAll("&nbsp;", " ");
            three_detail_tel.setText("- 电话 : " + tel);
        }
        ...
        String strUrl1 = "http://api.visitkorea.or.kr/openapi/service/rest/ChsService/detailCommon?areaCode=1&MobileOS=ETC&MobileApp=app&ServiceKey=834oAdPjoTtX%2FCihn6VDwM6KuVD3qhnZxf%2F%2F9vJ3emazbqrFpz1CV%2BULbzJUOhr7c797esiz8MaaeHQoq%2BSCbA%3D%3D&defaultYN=Y&overviewYN=Y&contentId=" + contentid;
        downTask1.execute(strUrl1);

        DownloadWebpageTask downTask = new DownloadWebpageTask();
        System.out.println(contentid);
        String strUrl = "http://api.visitkorea.or.kr/openapi/service/rest/ChsService/detailIntro?areaCode=1&MobileOS=ETC&MobileApp=app&ServiceKey=834oAdPjoTtX%2FCihn6VDwM6KuVD3qhnZxf%2F%2F9vJ3emazbqrFpz1CV%2BULbzJUOhr7c797esiz8MaaeHQoq%2BSCbA%3D%3D&contentId=" + contentid + "&contentTypeId=80&MobileOS=AND&MobileApp=AppTesting";
        downTask.execute(strUrl);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {//버튼을 누르면 실행됨
                Intent intent1 = new Intent(DetailThreeActivity_CHN.this, ShowMapOne.class);//인텐트로 보내지는곳의 클래스와,보낼곳의 위치 DetailOneActivity->ShowMapOne
