 ...
 */
public class DetailTwoActivity_CHN extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strUrl1 = "http://api.visitkorea.or.kr/openapi/service/rest/ChsService/detailCommon?ServiceKey=834oAdPjoTtX%2FCihn6VDwM6KuVD3qhnZxf%2F%2F9vJ3emazbqrFpz1CV%2BULbzJUOhr7c797esiz8MaaeHQoq%2BSCbA%3D%3D&contentId=" + contentid + "&contentTypeId=82&defaultYN=Y&mapImageYN=Y&firstImageYN=Y&areacodeYN=Y&catcodeYN=Y&addrinfoYN=Y&mapinfoYN=Y&overviewYN=Y&transGuideYN=Y&MobileOS=AND&MobileApp=WhereToGoSeoul";
        downTask1.execute(strUrl1);

        DownloadWebpageTask downTask = new DownloadWebpageTask();
        //System.out.println("contentid :"+contentid);
        String strUrl = "http://api.visitkorea.or.kr/openapi/service/rest/ChsService/detailIntro?ServiceKey=834oAdPjoTtX%2FCihn6VDwM6KuVD3qhnZxf%2F%2F9vJ3emazbqrFpz1CV%2BULbzJUOhr7c797esiz8MaaeHQoq%2BSCbA%3D%3D&contentId=" + contentid + "&contentTypeId=82&introYN=Y&MobileOS=AND&MobileApp=WhereToGoSeoul";
        downTask.execute(strUrl);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {//버튼을 누르면 실행됨
                Intent intent1 = new Intent(DetailTwoActivity_CHN.this, ShowMap.class);//인텐트로 보내지는곳의 클래스와,보낼곳의 위치 DetailOneActivity->ShowMapOne
    ...
    class DownloadWebpageTask1 extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (firstimage == null) {
                    Glide.with(DetailTwoActivity_CHN.this)
                ...
                if (zipcode == null) {
                    ...
                    textView_zipcode.setText("- 邮政编码 : " + zipcode);
                }
                if (addr2 == null) {
                    textView_addr1.setText("- 地址 : " + addr1);
                } else {
                    textView_addr1.setText("- 地址 : " + addr1 + " " + addr2);
                }
                if (tel == null) {
                    textView_tel.setText("- 电话 : N/A");
