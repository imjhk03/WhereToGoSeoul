 ...
 */
public class DetailOneActivity_ENG extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (zipcode == null) {
            ...
            one_detail_zipcode.setText("- Zipcode : " + zipcode);
        }
        if (addr2 == null) {
            one_detail_addr1.setText("- Address : " + addr1);
        } else {
            one_detail_addr1.setText("- Address : " + addr1 + " " + addr2);
        }
        if (tel == null) {
            one_detail_tel.setText("- Tel : N/A");
            ...
            tel = tel.replaceAll("<br/>", "\n");
            tel = tel.replaceAll("&nbsp;", " ");
            one_detail_tel.setText("- Tel : " + tel);
        }
        ...
        String strUrl = "http://api.visitkorea.or.kr/openapi/service/rest/EngService/detailCommon?ServiceKey=834oAdPjoTtX%2FCihn6VDwM6KuVD3qhnZxf%2F%2F9vJ3emazbqrFpz1CV%2BULbzJUOhr7c797esiz8MaaeHQoq%2BSCbA%3D%3D&contentId=" + contentid + "&defaultYN=Y&mapImageYN=Y&firstImageYN=Y&areacodeYN=Y&catcodeYN=Y&addrinfoYN=Y&mapinfoYN=Y&overviewYN=Y&transGuideYN=Y&MobileOS=AND&MobileApp=WhereToGoSeoul";
        downTask.execute(strUrl);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {//버튼을 누르면 실행됨
                Intent intent1 = new Intent(DetailOneActivity_ENG.this, ShowMapOne.class);//인텐트로 보내지는곳의 클래스와,보낼곳의 위치 DetailOneActivity->ShowMapOne
